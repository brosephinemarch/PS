...
dataSet[dataSetVersion].characterData = [
  {
    name: "Ko Hoonjeong (고훈정) Forte di Quattro, Musical Actor/Classical - Baritone",
    tooltip: "Forte di Quattro, Musical Actor/Classical - Baritone; 포르테 디 콰트로, 성악가/뮤지컬배우 - 바리톤",
    img: "kohoonjeong.png",
    opts: {
      season: [ "S1" ],
